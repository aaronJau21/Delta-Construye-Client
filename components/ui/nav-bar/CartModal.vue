<template>
  <Teleport to="body">
    <div
      v-if="isOpen"
      class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-[9999]"
    >
      <div
      ...
      >
        ...
        <div class="space-y-4 max-h-72 overflow-y-auto px-2">
          <div
            v-for="product in shoppingStore.itemsCart"
            :key="product.id"
          ...
          >
            ...
            <button
              ...
              @click="shoppingStore.removeFromCart(product.id)"
            >
        ...
        <div class="border-t">
          <div class="flex justify-between items-center py-4 px-2">
            ...
            <p class="mr-4 text-md font-semibold text-green-600">
              S/. {{ shoppingStore.totalPrice.toFixed(2) }}
            </p>
          </div>
          <button
